...
public class chatserver {
	...
	final String INET_ADDR = "192.168.56.104";
    final int PORT = 8888;
	/**
	...
	private void initialize() {
		...
		JButton bt6 = new JButton("Thank you");
		...
		JButton bt8 = new JButton("Welcome");
		...
		bt5.setBounds(356, 269, 85, 30);
		frmServer.getContentPane().add(bt5);

		JButton bt7 = new JButton("Bye");
